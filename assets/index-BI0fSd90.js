...
void main() {
    ...
    `,re=p*Math.PI/180,ie=Math.sin(.4),ae=Math.cos(.4),oe=new Ci({vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = vec4(position, 1.0);
      }
    `,fragmentShader:M,uniforms:{uTime:{value:0},uResolution:{value:new W(a,l)},uMouse:{value:C.current},uTopColor:{value:ne(e)},uBottomColor:{value:ne(t)},uIntensity:{value:n},uInteractive:{value:i},uGlowAmount:{value:o},uPillarWidth:{value:s},uPillarHeight:{value:c},uNoiseIntensity:{value:u},uLightMode:{value:+!!h},uRotCos:{value:1},uRotSin:{value:0},uPillarRotCos:{value:Math.cos(re)},uPillarRotSin:{value:Math.sin(re)},uWaveSin:{value:ie},uWaveCos:{value:ae}},transparent:!0,depthWrite:!1,depthTest:!1});y.current=oe;let se=new mi(2,2);S.current=se;let ce=new ti(se,oe);d.add(ce);let le=null,ue=e=>{if(!i||le)return;le=window.setTimeout(()=>{le=null},16);let t=r.getBoundingClientRect(),n=(e.clientX-t.left)/t.width*2-1,a=-((e.clientY-t.top)/t.height)*2+1;C.current.set(n,a)};i&&r.addEventListener(`mousemove`,ue,{passive:!0});let N=performance.now(),de=1e3/(A===`low`?30:60),fe=e=>{if(!y.current||!v.current||!b.current||!x.current)return;let t=e-N;if(t>=de){w.current+=.016*T.current;let n=w.current;y.current.uniforms.uTime.value=n,y.current.uniforms.uRotCos.value=Math.cos(n*.3),y.current.uniforms.uRotSin.value=Math.sin(n*.3),v.current.render(b.current,x.current),N=e-t%de}_.current=requestAnimationFrame(fe)};_.current=requestAnimationFrame(fe);let pe=null,me=()=>{pe&&clearTimeout(pe),pe=window.setTimeout(()=>{if(!v.current||!y.current||!g.current)return;let e=g.current.clientWidth,t=g.current.clientHeight;v.current.setSize(e,t),y.current.uniforms.uResolution.value.set(e,t)},150)};return window.addEventListener(`resize`,me,{passive:!0}),()=>{window.removeEventListener(`resize`,me),i&&r.removeEventListener(`mousemove`,ue),_.current&&cancelAnimationFrame(_.current),v.current&&(v.current.dispose(),v.current.forceContextLoss(),r.contains(v.current.domElement)&&r.removeChild(v.current.domElement)),y.current&&y.current.dispose(),S.current&&S.current.dispose(),v.current=null,y.current=null,b.current=null,x.current=null,S.current=null,_.current=null}},[E,m]),(0,l.useEffect)(()=>{T.current=r},[r]),(0,l.useEffect)(()=>{if(!y.current)return;let t=e=>{let t=new Fn(e);return new G(t.r,t.g,t.b)};y.current.uniforms.uTopColor.value=t(e)},[e]),(0,l.useEffect)(()=>{if(!y.current)return;let e=e=>{let t=new Fn(e);return new G(t.r,t.g,t.b)};y.current.uniforms.uBottomColor.value=e(t)},[t]),(0,l.useEffect)(()=>{y.current&&(y.current.uniforms.uIntensity.value=n)},[n]),(0,l.useEffect)(()=>{y.current&&(y.current.uniforms.uInteractive.value=i)},[i]),(0,l.useEffect)(()=>{y.current&&(y.current.uniforms.uGlowAmount.value=o)},[o]),(0,l.useEffect)(()=>{y.current&&(y.current.uniforms.uPillarWidth.value=s)},[s]),(0,l.useEffect)(()=>{y.current&&(y.current.uniforms.uPillarHeight.value=c)},[c]),(0,l.useEffect)(()=>{y.current&&(y.current.uniforms.uNoiseIntensity.value=u)},[u]),(0,l.useEffect)(()=>{y.current&&(y.current.uniforms.uLightMode.value=+!!h)},[h]),(0,l.useEffect)(()=>{if(!y.current)return;let e=p*Math.PI/180;y.current.uniforms.uPillarRotCos.value=Math.cos(e),y.current.uniforms.uPillarRotSin.value=Math.sin(e)},[p]),E?(0,f.jsx)(`div`,{ref:g,className:`light-pillar-container ${a}`,style:{mixBlendMode:d}}):(0,f.jsx)(`div`,{className:`light-pillar-fallback ${a}`,style:{mixBlendMode:d},children:`WebGL not supported`})};function Ic(){return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(`div`,{style:{position:`fixed`,top:0,left:0,width:`100vw`,height:`100vh`,zIndex:-1,pointerEvents:`none`,backgroundColor:`#09090b`},children:(0,f.jsx)(Fc,{topColor:`#88210c`,bottomColor:`#ff9200`,intensity:1,rotationSpeed:.4,glowAmount:.002,pillarWidth:3,pillarHeight:.5,noiseIntensity:.5,pillarRotation:43,interactive:!1,mixBlendMode:`normal`})}),(0,f.jsxs)(`div`,{className:`portfolio-container`,style:{position:`relative`,zIndex:1},children:[(0,f.jsxs)(`header`,{className:`hero`,children:[(0,f.jsx)(`h1`,{children:`Sai's Engineering Portfolio`}),(0,f.jsx)(`p`,{children:`Mechanical Engineering & Propulsion Systems`})]}),(0,f.jsx)(`div`,{className:`projects-grid`,children:[{title:`Cold Spray Development`,description:`Inert gas shrouding system to minimize oxygen contamination.`},{title:`Parametric Cycle Analysis & CFD Nozzle Design`,description:`Thermodynamic analysis script and plug nozzle design for a jet engine.`},{title:`Grounds Fluids System`,description:`P&ID for high-pressure gaseous nitrogen handling for rocket testing.`},{title:`Launch Lugs Design`,description:`Dual-pin rail departure mechanism and clearance analysis.`}].map((e,t)=>(0,f.jsx)(`a`,{href:`#`,className:`project-card`,children:(0,f.jsx)(C,{edgeSensitivity:30,glowColor:`30 100 50`,backgroundColor:`rgba(0, 0, 0, 0.7)`,borderRadius:28,glowRadius:40,glowIntensity:1,coneSpread:25,animated:!0,colors:[`#ff7b00`,`#ffb700`,`#ff3300`],className:`w-full h-full flex`,children:(0,f.jsxs)(`div`,{className:`project-content`,children:[(0,f.jsx)(`h2`,{children:e.title}),(0,f.jsx)(`p`,{children:e.description})]})})},t))})]})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,f.jsx)(l.StrictMode,{children:(0,f.jsx)(Ic,{})}));